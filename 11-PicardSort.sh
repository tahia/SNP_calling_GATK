...
do
    ...
    echo "java -jar -Xmx4G $TACC_PICARD_DIR/build/libs/picard.jar BuildBamIndex OUTPUT=$OBAM INPUT=$OFIL VALIDATION_STRINGENCY=LENIENT" >>bam-index-3.param
done
...
split -l 522 --additional-suffix=picard-sort-2.param picard-sort-2.param 
